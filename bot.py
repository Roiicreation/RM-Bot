...
def run_bot():
    # Ottieni la porta dall'ambiente o usa un valore predefinito
    port = int(os.getenv('PORT', 8080))
    
    # Crea un web server asincrono semplice per soddisfare i requisiti di Render
    ...
    # Avvia il bot con il web server
    while True:
        try:
            if TOKEN is None:
            ...
            # Avvia il web server prima del bot
